...
const App = () => {
  ...
  return (
    <View style={styles.containerb1}>
         <ImageBackground source={require('../assets/3Artist.png')} style={styles.backgroundImage}blurRadius = {1}>

      <View style={styles.label}> 

        <Text style = {styles.ArtistName}>Adam Christopher</Text>
      ...
      <ImageBackground 
        ...
        <Text style = {styles.album1title}>Peaches - Acoustic</Text>
        <Text style = {styles.album2title}>Iris - Acoustic </Text>
        <Text style = {styles.album3title}>10,000 Hours - Acoustic</Text>
        <Text style = {styles.album4title}>So Far Away - Acoustic</Text>

        <Text style = {styles.songInfo1}>2022 | Folk</Text>
        <Text style = {styles.songInfo11}>3:10</Text>

        <Text style = {styles.songInfo2}>2018 | Folk</Text>
        <Text style = {styles.songInfo22}>3:04</Text>

        <Text style = {styles.songInfo3}>2007 | Folk</Text>
        <Text style = {styles.songInfo33}>2:49</Text>

        <Text style = {styles.songInfo4}>2006 | Folk</Text>
        <Text style = {styles.songInfo44}>3:27</Text>

      <ImageBackground source={require("../assets/3Artist.png")} style = {styles.ArtistImage}/>
